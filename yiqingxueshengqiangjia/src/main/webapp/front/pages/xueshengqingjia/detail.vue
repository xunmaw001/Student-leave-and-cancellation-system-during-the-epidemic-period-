...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback"
		...
		<view class="container">
			...
			<!-- 名字-->
						<view :style='{"textAlign":"left","fontSize":"45upx","color":"black"}'>{{detail.xueshengqingjiaName}}
						</view>
				</view>
   	 <view style="margin-top: 10rpx;"></view>
					...
					<view class="detail-list-item"
                        ...
                        <view class="text" :style='{"color":"#06A9FF","textAlign":"center","fontSize":"24rpx"}'>
                            {{detail.xueshengqingjiaText}}</view>
                    </view>
					<view class="detail-list-item"
						  :style='{"boxShadow":"0 0 4rpx 0 #006633 insta","margin":"0 60rpx 0 60rpx","borderColor":"rgba(218, 218, 218, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"68rpx"}'>
						<view class="lable"
							...
							请假类型：</view>
						<view class="text" :style='{"color":"#06A9FF","textAlign":"center","fontSize":"24rpx"}'>
                            {{detail.xueshengqingjiaValue}}</view>
					</view>
					<view class="detail-list-item"
                          :style='{"boxShadow":"0 0 4rpx 0 #006633 insta","margin":"0 60rpx 0 60rpx","borderColor":"rgba(218, 218, 218, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"68rpx"}'>
                        <view class="lable"
							...
							请假时间：</view>
                        <view class="text" :style='{"color":"#06A9FF","textAlign":"center","fontSize":"24rpx"}'>
                            {{detail.xueshengqingjiaTime}}</view>
                    </view>
					<view class="detail-list-item"
						  :style='{"boxShadow":"0 0 4rpx 0 #006633 insta","margin":"0 60rpx 0 60rpx","borderColor":"rgba(218, 218, 218, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"68rpx"}'>
						<view class="lable"
							...
							请假天数：</view>
						<view class="text" :style='{"color":"#06A9FF","textAlign":"center","fontSize":"24rpx"}'>
							{{detail.xueshengqingjiaNumber}}</view>
					</view>
					<view class="detail-list-item"
						  :style='{"boxShadow":"0 0 4rpx 0 #006633 insta","margin":"0 60rpx 0 60rpx","borderColor":"rgba(218, 218, 218, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"68rpx"}'>
						<view class="lable"
							...
							审核结果：</view>
						<view class="text" :style='{"color":"#06A9FF","textAlign":"center","fontSize":"24rpx"}'>
                            {{detail.xueshengqingjiaYesnoValue}}</view>
					</view>
					<view class="detail-list-item"
                          :style='{"boxShadow":"0 0 4rpx 0 #006633 insta","margin":"0 60rpx 0 60rpx","borderColor":"rgba(218, 218, 218, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"68rpx"}'>
                        <view class="lable"
							...
							处理结果：</view>
                        <view class="text" :style='{"color":"#06A9FF","textAlign":"center","fontSize":"24rpx"}'>
                            {{detail.xueshengqingjiaYesnoText}}</view>
                    </view>
					<view class="detail-list-item"
						  :style='{"boxShadow":"0 0 4rpx 0 #006633 insta","margin":"0 60rpx 0 60rpx","borderColor":"rgba(218, 218, 218, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"68rpx"}'>
						<view class="lable"
							...
							请假状态：</view>
						<view class="text" :style='{"color":"#06A9FF","textAlign":"center","fontSize":"24rpx"}'>
                            {{detail.xueshengqingjiaStatusValue}}</view>
					</view>
			</view>
	...
	export default {
		...
		methods: {
			...
			async init() {
				...
				// 主图
				this.swiperList = this.detail.xueshengqingjiaPhoto ? this.detail.xueshengqingjiaPhoto.split(",") : [];
			},
